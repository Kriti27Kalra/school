  ...
  $('#academicyearid').on('change', function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $("#admissionid option[value='17']").remove();
        $("#admissionid option[value='18']").remove();
        $("#admissionid option[value='19']").remove();
        $("#admissionid option[value='20']").remove();
        $("#admissionid option[value='21']").remove();
        $("#admissionid option[value='22']").remove();
        $("#admissionid option[value='23']").remove();
        $("#admissionid option[value='24']").remove();
        $("#admissionid option[value='25']").remove();
        $("#admissionid option[value='26']").remove();
        $("#admissionid option[value='27']").remove();
      },
...
$(document).ready(function () {
  ...
  $("#guardian-checkbox").click(function () {
    ...
    if ($(this).is(":checked")) {
      ...
      setTimeout(function () {
        $("#guardian-row").find(":input").val("");
        $("#guardian-row").find(":input").parent().removeClass("focused");
      }, 1000);
...
function showNeedDoc(val) {
  if (val == "Yes") {
    $("#in_the_case_of_differently_abled_candidates").addClass("mandatoryvalue");
    $(".diffMark").show();
    $(".diff_abled").show();
    $(".diffrentlyableddiv").show();
    $(".diffrentlyableddivman").addClass("mandatoryvalue");
  } else {
    $("#in_the_case_of_differently_abled_candidates").removeClass("mandatoryvalue");
    $(".diffMark").hide();
    $(".diff_abled").hide();
